...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button4 = tk.Button(self, text="Visit Page 4",
                            command=lambda: controller.show_frame(PageFour))
        button4.pack()

        button5 = tk.Button(self, text="Visit Page 5",
                            command=lambda: controller.show_frame(PageFive))
        button5.pack()

        button6 = tk.Button(self, text="Visit Page 6",
                            command=lambda: controller.show_frame(PageSix))
        button6.pack()

        button7 = tk.Button(self, text="Visit Page 7",
                            command=lambda: controller.show_frame(PageSeven))
        button7.pack()

        button8 = tk.Button(self, text="Visit Page 8",
                            command=lambda: controller.show_frame(PageEight))
        button8.pack()

        button9 = tk.Button(self, text="Visit Page 9",
