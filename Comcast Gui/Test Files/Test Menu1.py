...
Begin MenuBar
######################################################################################################################################
## tk_menubar.py - Works, but none of the menu items actually do anything 7-14-2017
# !/usr/bin/env python
#
#import tkinter as tk
#
...
Begin Selectable
######################################################################################################################################
## tk_selectable.py - Modified Version Works 7-14-2017
## !/usr/bin/python
#
#import tkinter as tk
#
...
Begin Callback with Params
######################################################################################################################################
# tk_callback_with_params.py - Works, nothing has been changed 7-14-2017
# !/usr/bin/python
...
if __name__ == '__main__':
    main()
######################################################################################################################################
End Callback with Params

Begin Button
######################################################################################################################################
## tk_button.py - Works, nothing has been changed 7-14-2017
## !/usr/bin/python
#
#import tkinter as tk
#
