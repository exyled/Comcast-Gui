...
class PageOne_1(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="1. VVX310 UserGuide",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX310\VVX310_UserGuide.pdf")) #Works like it is supposed to.
                            #(OLD CODE)controller.show_frame("PageOne1"))
        button1.pack()
        button2 = tk.Button(self, text="2. VVX400 UserGuide",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX310\VVX400_UserGuide.pdf")) #Works like it is supposed to.
        button2.pack()
        button3 = tk.Button(self, text="1. VVX500 UserGuide",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX500\VVX500_UserGuide.pdf")) #Works like it is supposed to.
        button3.pack()
        button4 = tk.Button(self, text="1. VVX500 Admin",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX500\VVX500_Admin.pdf")) #Works like it is supposed to.
        button4.pack()
        button5 = tk.Button(self, text="1. VVX500 QuickGuide",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX500\VVX500_QuickGuide.pdf")) #Works like it is supposed to.
        button5.pack()
        button6 = tk.Button(self, text="1. VVX550 Admin",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX500\VVX550_Admin.pdf")) #Works like it is supposed to.
        button6.pack()
        button7 = tk.Button(self, text="1. VVX600 UserGuide",
                            command=lambda: os.startfile("..\Files\PhoneManuals\VVX600\VVX600_UserGuide.pdf")) #Works like it is supposed to.
        button7.pack()
        button8 = tk.Button(self, text="1. Conference Phone 6000",
                            command=lambda: os.startfile("..\Files\PhoneManuals\IP6000_UserGuide.pdf")) #Works like it is supposed to.
        button8.pack()
